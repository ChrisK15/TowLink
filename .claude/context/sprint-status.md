...
1. **TOW-16** - See Assigned Driver Details (IN PROGRESS - START HERE)
2. **TOW-75** - Driver Account Setup Screen (independent)
3. **TOW-24** - Location Permission Handling (supporting infrastructure)
